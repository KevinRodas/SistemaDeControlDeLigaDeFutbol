...
<body id="container-page-index">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 text-center">
                   <article style="margin-top:20%;">
                        ...
                        <h3>Registrate</h3>
                        <p>Registrese y hagase cliente de <span class="tittles-pages-logo">Handal y Sobrinos</span> para recibir las mejores ofertas y descuentos especiales de nuestros productos.</p>
    ...
    <section id="distribuidores-index">
        <div class="container">
            ...
            <div class="col-xs-12">
                <div class="page-header">
                  <h1><small style="color: #333;"> Nuestras Marcas</small></h1>
                </div>
                <br><br>
