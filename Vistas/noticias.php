...
<div class="card">
    ...
    <div class="face back">
        <h3>Noticia</h3>
        <p>Este mañana recibieron 39 entrenadores, entre ellos uno del género femenino, sus Diplomas que los acredita como entrenadores Clase “E” autorizado por la Federación Salvadoreña de Fútbol y la Asociación Departamental de Fútbol Aficionado de La Libertad, que se desarrolló desde el 3 de diciembre 2021 hasta el 25 de febrero del año 2022 en Santa Tecla.</p>
        <div class="link">
            <a href=""></a>
        </div>
    </div>
...
<div class="card">
    ...
    <div class="face back">
        <h3>Noticia</h3>
        <p>Los dirigidos por Rudis González Gallo vencieron 3-2 a la escuadra dirigida por Francisco Cati.

Los Salvadoreños sostuvieron un partido con mucha intensidad; pero no dejaron de luchar por conseguir dejar la corona en casa.
...
<div class="card">
    ...
    <div class="face back">
        <h3>Noticia</h3>
        <p>Que al seleccionado nacional Roberto Carlos Domínguez, se le realizó ULTRASONOGRAFIA DE CONTROL, posterior a desgarro muscular del bíceps femoral derecho, sufrido el pasado 27 de marzo del 2022 en partido eliminatorio El Salvador vs Costa Rica, persistiendo aun una microrrotura fibrilar, razón por la cual no tiene el alta médica para poder entrenar y jugar con normalidad, informó el Doctor Heriberto Guerrero, médico de la selección nacional.</p>
        <div class="link">
            <a href=""></a>
        </div>
    </div>
